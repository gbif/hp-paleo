...
[![Build Status](https://builds.gbif.org/job/hp-paleo/badge/icon)](https://builds.gbif.org/job/hp-paleo/lastBuild/console)
...
# GBIF Hosted Portal: paleo

This Jekyll website, **[paleo (Staging)](https://paleo.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
